...
### 1. Sign up
    ...
    Στην συνέχεια γίνεται έλεγχος για το αν υπάρχει ήδη ένας χρήστης με το ίδιο email η user name στα σύστημα και εισάγονται δυο νέα στοιχεία, η κατηγορία του χρήστη που παίρνει τιμή ‘user’ και μια μεταβλητή που ελέγχει αν έχει κάνει login:
...
### 6. Flight reservation
    ...
    στην συνέχεια ελέγχει αν υπάρχουνε θέσεις ελεύθερες για την κατηγορία που θέλει να κάτσει ο χρήστης (economy, business). Αν βρει τότε μειώνει κατά 1 το στοιχείο που δείχνει πόσες ελεύθερες θέσεις υπάρχουνε στην πτήση
...
### 12. Update flight information
    ...
    logedin_test_admin(email, password)
    ```
    τα στοιχεία που μπορεί να τροποποιήσει είναι τα κότσοι (economy class & business class). άρα παίρνει το id και τις κατηγορίες που θέλει να τροποποιήσει από τον χρήστη και τα εισάγει στο σύστημα
    economy class:
    ```
...
### 14. find extensive details about a flight
    ...
    και υπολογίζει πόσα economy και business tickets έχουνε αγοραστεί από το collection των κρατήσεων.  Επίσης εισάγει κάθε φορά και τα στοιχεία του κάθε χρήστη που έχει κάνει reservation
